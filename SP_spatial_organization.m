...
% Option 2: find all h5 files in current folder
...
for i = 1:length(in_file_list)
    ...
    % get the AEF data for Hm0 and swl
...
% plot swl AEF at superimposed points along distance (along line of shapefile)
...
% plot savepoint swl AEF information from sorted table
figure(4)
